/*
	...
	Строки
	- появились обратные кавычки - `` (они учитвыают пробелы и в них можно задавать переменные и выражения)
	- новые методы
		...
		.trim()   /   .trimEnd()   /   .trimStart() - удалить пробелы
		.padStart()   / .padEnd() - задать минимальную длину строки
